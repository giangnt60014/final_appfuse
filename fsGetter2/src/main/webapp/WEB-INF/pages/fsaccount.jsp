...
<div class="span10">
	...
	<%-- <display:table name="fsaccountList"
		class="table table-condensed table-striped table-hover" requestURI=""
		id="getterList" export="true" pagesize="25">
		<display:column property="id" sortable="true" href="personform"
			media="html" paramId="id" paramProperty="id" titleKey="getter.id" />
		<display:column property="account" sortable="true"
			titleKey="getter.account" />
		<display:column property="security" sortable="true"
			titleKey="getter.security" />
	</display:table> --%>
